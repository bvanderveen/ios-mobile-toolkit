...
@interface RFCoverFlowController ()

@property (nonatomic, copy) NSArray *playlists;
@property (nonatomic, strong) CoverFlowVCView *coverFlowVCView;
@property (nonatomic, strong) RFPlaylistController *playlistController;
@property (nonatomic, strong) SimpleImageCache *cache;

@end


@implementation RFCoverFlowController
...
- (void)playlistTapped {
    self.playlistController = [[RFPlaylistController alloc] init];
