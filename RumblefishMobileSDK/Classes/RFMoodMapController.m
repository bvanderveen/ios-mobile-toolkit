...
#import "RFMoodMapSelectorView.h"
#import "RFColor.h"
#import "RFPreviewController.h"

@interface RFMoodMapControllerView : UIView
...
@implementation RFMoodMapControllerView
...
@interface RFMoodMapController () <RFMoodMapSelectorViewDelegate>
...
@implementation RFMoodMapController
...
- (void)viewDidLoad
{
    ...
    self.view = [[RFMoodMapControllerView alloc] initWithFrame:CGRectMake(0, 0, 320, 500)];
    ...
    _moodmapSelectorView = [[RFMoodMapSelectorView alloc] initWithFrame:CGRectMake(0, 0, 320, 320)];
