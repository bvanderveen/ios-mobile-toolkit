...
@protocol RFMoodMapSelectorViewDelegate <NSObject>
...
@interface RFMoodMapSelectorView : UIView
...
@property (nonatomic, weak) id <RFMoodMapSelectorViewDelegate>delegate;
