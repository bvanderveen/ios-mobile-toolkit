...
@interface RFOccasionController ()
...
@implementation RFOccasionController
...
- (id)init {
    if (self = [super initWithNibName:@"RFOccasionController" bundle:[NSBundle rumblefishResourcesBundle]]) {
...
- (void)gotoPlaylist {
    ...
    if (playlist == nil) {
        playlist = [[RFPlaylistController alloc] init];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RFSongCell *cell = [RFSongCell cellForMedia:media tableView:tableView buttonAction:^{
